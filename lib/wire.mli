...
val wire_size_of_struct : struct_ -> int option
(** [wire_size_of_struct s] computes the fixed wire size of struct [s] in bytes.
...
(** [to_ml_stubs structs] generates OCaml [external] declarations matching the C
    stubs from {!to_c_stubs}. For each struct [Foo], generates a module:
    {[
      module Foo : sig
