...
val wire_size : Wire.C.struct_ -> int option
(** [wire_size s] computes the fixed wire size of struct [s] in bytes. Returns
    [None] if the struct contains variable-length fields. *)
