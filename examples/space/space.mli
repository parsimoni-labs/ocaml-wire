...
val f_sp_data_len : Wire.UInt16.t Wire.Field.t
...
val bf_sp_data_len : (Wire.UInt16.t, packet) Wire.Codec.field
...
val f_oh_length : Wire.UInt16.t Wire.Field.t
...
val bf_oh_length : (Wire.UInt16.t, outer_hdr) Wire.Codec.field
